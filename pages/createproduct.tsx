  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center">
        ...
        <button className="w-[180px] h-[60px] rounded-[15px] border-[1px] border-gray-400 mb-10 hover:scale-[1.1] hover:bg-slate-900 text-[1.2rem] font-[600] hover:text-white transition-all ">
          Submit
        </button>
      </div>
      <Footer />
