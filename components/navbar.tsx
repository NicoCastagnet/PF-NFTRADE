...
export default function NavBar() {
  ...
  return (
    <nav className="navbar__nav bg-slate-900 w-full flex flex-col lg:flex-row text-center items-center p-2 pl-8 pr-8 justify-between mb-10">
      ...
      <div className="navbar__buttons flex flex-row flex-wrap justify-center items-center text-white">
        ...
        <button className="m-3" onClick={() => router.push('/marketplace')}>
          Marketplace
        </button>
